...
public enum PlayerAction {
    ...
    ACTIVATE_SHIELD,    //player chooses shields to activate and chooses battery to use // TODO: atomize
    ACTIVATE_CANNON,    //player chooses double cannons to activate or to submit
