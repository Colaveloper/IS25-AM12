...
public class PlanetsCardDeprecated extends AdventureCardDeprecated {
    //attributes
    ...
    public PlanetsCardDeprecated(FlightBoard flightBoard, int numPlanets, List<GoodsType> goods, int flightDaysLost){
        //attributes init
        super(flightBoard);
