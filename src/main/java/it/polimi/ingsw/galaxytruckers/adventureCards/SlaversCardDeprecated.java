...
public class SlaversCardDeprecated extends AdventureCardDeprecated {
    ...
    public SlaversCardDeprecated(FlightBoard flightBoard, int firePower, int credits, int sacrifices, int flightDaysLost) {
        super(flightBoard);
