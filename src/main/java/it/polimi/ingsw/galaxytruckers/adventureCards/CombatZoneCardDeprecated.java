...
public class CombatZoneCardDeprecated extends AdventureCardDeprecated {
    //attributes
    ...
    public CombatZoneCardDeprecated(FlightBoard flightBoard, int flightDaysLost, int numResidentsLost, List<Integer> projectileDirections, List<ProjectileDeprecated> projectileType){
        //cardState init
        super(flightBoard);
