...
public class AbandonedShipCardDeprecated extends AdventureCardDeprecated {
    private final int credits;
    private final int numResidents;
    private final int flightDaysLost;

    public AbandonedShipCardDeprecated(FlightBoard flightBoard, int credits, int numResidents, int flightDaysLost){
        super(flightBoard);
