...
public class SmugglersCardDeprecated extends AdventureCardDeprecated {
    ...
    public SmugglersCardDeprecated(FlightBoard flightBoard, List<GoodsType> loot, int flightDaysLost, int firePower, int goodsStolen) {
        super(flightBoard);
