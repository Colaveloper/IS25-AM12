...
import it.polimi.ingsw.galaxytruckers.view.cliScreens.CliForecastScreen;
import it.polimi.ingsw.galaxytruckers.view.cliScreens.CliGoodsScreen;
...
public class GoodsScreen implements ScreenFactory{
    @Override
    ...
    public CliScreen getCliScreen(ClientModel model, ClientController controller) throws IOException {
        return new CliGoodsScreen(model, controller);
    }
}
