...
import it.polimi.ingsw.galaxytruckers.view.cliScreens.CliCrewInitialization;
import it.polimi.ingsw.galaxytruckers.view.cliScreens.CliScreen;
import it.polimi.ingsw.galaxytruckers.view.model.ClientModel;

import java.io.IOException;

public class CrewInitialization implements ScreenFactory{
    @Override
    ...
    public CliScreen getCliScreen(ClientModel model, ClientController controller) throws IOException {
        return new CliCrewInitialization(model, controller);
    }
}
