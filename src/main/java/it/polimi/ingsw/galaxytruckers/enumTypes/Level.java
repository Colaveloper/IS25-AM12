...
//    private Map<Level, Integer> pileComposition;
    ...
    Level(List<Point> shipPoints, List<Point> stashPoints, Integer loopLength, List<Integer> startingPositions, Integer hourglassFlips) { // (, List<Level> pileComposition)
