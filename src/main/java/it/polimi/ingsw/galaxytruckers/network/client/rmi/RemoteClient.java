...
public interface RemoteClient extends Remote {
     ...
     */
    void setupLobby(UUID lobbyId, Map<String, Colors> playerColors) throws RemoteException;
     ...
     *                     their corresponding color
     */
    void updateLobbyPlayers(Map<String, Colors> playerColors) throws RemoteException;
