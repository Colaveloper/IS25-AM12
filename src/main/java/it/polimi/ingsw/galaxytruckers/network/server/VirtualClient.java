...
public interface VirtualClient {
     ...
     */
    void notifyFaceDownComponentRequest(String playerName, int componentId, int numFaceDown);
     ...
     */
    void notifyFaceUpComponentRequest(String playerName, int componentId, Set<Integer> faceUpComponentIds);
     ...
     */
    void notifyComponentRejection(String playerName, int componentId, Set<Integer> faceUpComponentIds);
     ...
     *                      positions
     */
    void notifyPlaceShipOnFlightBoard(String playerName, Map<String, Integer> playerToPlace);
