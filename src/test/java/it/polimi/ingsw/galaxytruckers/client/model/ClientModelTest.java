...
import it.polimi.ingsw.galaxytruckers.client.model.adventureCards.OpenSpaceCard;
...
class ClientModelTest {
    ...
    void notifyEventMethods() {
        ...
        AdventureCard adventureCard = new OpenSpaceCard(it.polimi.ingsw.galaxytruckers.shared.enums.Level.SECOND, 1);
        Player player = mock(Player.class);
